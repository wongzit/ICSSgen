...
print("*                                            $$$$                             *")
print("*                                                                             *")
print("*     =================== Version 1.3.1 (Source Code) ===================     *")
print("*                           Last update: 2021-04-22                           *")
print("*                                                                             *")
print("*      A ICSS input file generator, developed by Zhe Wang. Online document    *")
print("*    available from GitHub (https://github.com/wongzit/ICSSgen).              *")
print("*                                                                             *")
print("*                             -- Catch me with --                             *")
...
print("eg. (Windows): C:\\ICSSgen\\example\\benzene.gjf")
fileName = input("    (macOS/Linux): /ICSSgen/example/benzene.gjf\n")
if fileName.strip()[0] == '\'' and fileName.strip()[-1] == '\'':
    fileName = fileName[1:-2]

# For Microsift Windows
#fileName = input("(eg.: C:\\ICSSgen\\example\\benzene.gjf)\n")
